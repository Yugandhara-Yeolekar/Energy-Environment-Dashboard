...
st.text("""The deviation in a specific month's average surface temperature from the mean temperature of the same month during the period 1991-2020, measured in degrees Celsius.""")
